...
const QUESTIONS: Question[] = [
  {
    ...
    options: [
      { label: "Episch", weights: { taylor: 2, laufey: 1 } },
      {
        label: "Erwachsen",
        weights: { sabrina: 2, billie: 1 },
      },
      { label: "Ruhig", weights: { billie: 2, taylor: 1 } },
      { label: "Cozy", weights: { laufey: 2, billie: 1 } },
    ],
  },
  {
    id: "lyrics",
    ...
    options: [
      { label: "Poetisch", weights: { taylor: 2 } },
      { label: "Humorvoll", weights: { sabrina: 2 } },
      { label: "Minimalistisch", weights: { billie: 2 } },
      { label: "Verträumt", weights: { laufey: 2 } },
    ],
  },
  {
    id: "sound",
    ...
    options: [
      { label: "Vielseitig", weights: { taylor: 2 } },
      {
        label: "90s Country",
        weights: { sabrina: 2 },
      },
      { label: "Düster", weights: { billie: 2 } },
      { label: "Jazz", weights: { laufey: 2 } },
    ],
  },
];
