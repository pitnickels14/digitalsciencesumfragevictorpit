...
const QUESTIONS: Question[] = [
  {
    ...
    options: [
      { label: "Episch & euphorisch", weights: { taylor: 2, laufey: 1 } },
      {
        label: "Melancholisch & erwachsen",
        weights: { sabrina: 2, taylor: 1 },
      },
      { label: "Düster & intim", weights: { billie: 2 } },
      { label: "Nachtfahrt & Club-Vibes", weights: { laufey: 2, billie: 1 } },
    ],
  },
  {
    id: "lyrics",
    ...
    options: [
      ...
      { label: "Mysteriös & verführerisch", weights: { laufey: 2 } },
    ],
  },
  {
    id: "sound",
    ...
    options: [
      ...
      { label: "Synthwave & R&B", weights: { laufey: 2 } },
    ],
  },
];
